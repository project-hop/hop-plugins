...
public class DropboxInput extends BaseTransform<DropboxInputMeta, DropboxInputData> {
  private static Class<?> PKG =
      DropboxInputMeta.class; // for i18n purposes, needed by Translator2!!   $NON-NLS-1$

  public DropboxInput(
      TransformMeta transformMeta,
      DropboxInputMeta meta,
      DropboxInputData data,
      int copyNr,
  ...
  public boolean processRow() throws HopException {
          ...
          if (data.successfulRowSet == null) {
            throw new HopException(
                BaseMessages.getString(
                    PKG,
                    "DropboxInput.Log.TargetTransformInvalid",
    ...
    try {
      ...
      logError(
          BaseMessages.getString(
              PKG, "DropboxInput.Log.ErrorReadingFile", sourceFile, ex.getMessage()));
      putFailedTransferRow(r);
      return true;
    }
